    ...
    return (
        <section className="home section" id="home">
            <div className="home_container container ">
              {isModalOpen && <Contact isModalOpen={isModalOpen} setIsModalOpen ={setIsModalOpen}/>}
                ...
                <div className="home_content grid">
                    ...
                    {/* <SocialLink/> */}
                      <Banner/>
                        ...
                        {/* <svg xmlns="http://www.w3.org/2000/svg"  height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 612 612" style = {{fill: "var(--button-text-color)"}} className="button__icon"> */}
                        

                        <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="800px" height="800px" viewBox="0 0 32 32" version="1.1" style = {{fill: "var(--button-text-color)"}} className="button__icon">
