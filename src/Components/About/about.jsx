                ...
                <div className="description_container">
                    <div className="about_container">
                        <div className="about_img_description_1_wrapper">
                            ...
                            I’m a software engineer based in Austin, Texas, with extensive experience in frontend development using React, HTML, CSS, and JavaScript. One of my most rewarding projects was redesigning GM’s eCommerce site, where I applied my UI expertise and learned new tools like TypeScript and Storybook's <a className = "about_underline_word" href="https://bradfrost.com/blog/post/atomic-design-and-storybook/">atomic design</a>. Outside of work, I love exploring the latest JavaScript frameworks and packages, always on the lookout for new ways to improve the development experience. <br></br>
